...
namespace BellyFish.Source.Game.Gameplay {
    class GameManager : Singleton<GameManager> {
        ...
        public void StartGame() {
            var board = InitializeCheckerboard();
        ...
        private Checkerboard InitializeCheckerboard() {
            return new Checkerboard(GetInitialPawns());
        }

        IEnumerable<Pawn> GetInitialPawns() {
            ...
            yield return new Pawn(new Position('f', 1), PawnColor.White, PawnType.King, queenMoveStrategy);
            yield return new Pawn(new Position('f', 8), PawnColor.Black, PawnType.King, queenMoveStrategy);
        }
    }
}
